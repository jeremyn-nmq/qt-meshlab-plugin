...
void GLLogStream::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GLLogStream *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (GLLogStream::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GLLogStream::logUpdated)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GLLogStream::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_GLLogStream.data,
    qt_meta_data_GLLogStream,
    qt_static_metacall,
    nullptr,
    nullptr
} };
