...
#include <memory>
#include "../../../../../meshlabplugins/io_u3d/io_u3d.h"
...
struct qt_meta_stringdata_U3DIOPlugin_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_U3DIOPlugin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_U3DIOPlugin_t qt_meta_stringdata_U3DIOPlugin = {
    {
QT_MOC_LITERAL(0, 0, 11) // "U3DIOPlugin"
...
QT_INIT_METAOBJECT const QMetaObject U3DIOPlugin::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_U3DIOPlugin.data,
    qt_meta_data_U3DIOPlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *U3DIOPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_U3DIOPlugin.stringdata0))
...
static constexpr unsigned char qt_pluginMetaData[] = {
    ...
    '1',  '.',  '0', 
    // "className"
    0x03,  0x6b,  'U',  '3',  'D',  'I',  'O',  'P', 
    'l',  'u',  'g',  'i',  'n', 
    0xff, 
};
QT_MOC_EXPORT_PLUGIN(U3DIOPlugin, U3DIOPlugin)
