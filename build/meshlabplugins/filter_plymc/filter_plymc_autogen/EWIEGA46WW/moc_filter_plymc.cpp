...
#include <memory>
#include "../../../../../meshlabplugins/filter_plymc/filter_plymc.h"
...
struct qt_meta_stringdata_PlyMCPlugin_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PlyMCPlugin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PlyMCPlugin_t qt_meta_stringdata_PlyMCPlugin = {
    {
QT_MOC_LITERAL(0, 0, 11) // "PlyMCPlugin"
...
QT_INIT_METAOBJECT const QMetaObject PlyMCPlugin::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_PlyMCPlugin.data,
    qt_meta_data_PlyMCPlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PlyMCPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PlyMCPlugin.stringdata0))
...
static constexpr unsigned char qt_pluginMetaData[] = {
    ...
    'g',  'i',  'n',  '/',  '1',  '.',  '0', 
    // "className"
    0x03,  0x6b,  'P',  'l',  'y',  'M',  'C',  'P', 
    'l',  'u',  'g',  'i',  'n', 
    0xff, 
};
QT_MOC_EXPORT_PLUGIN(PlyMCPlugin, PlyMCPlugin)
